...
export default function LoginScreen({ navigation }) {
  ...
  const handleLogin = async (loginCredential) => {
    try {
      const res = await API.post("api/store/login", loginCredential);
      if (res.data) {
            ...
            {(props) => {
              return (
                <>
                  ...
                  >
                    <Text style={FormStyle.forgotText}>
                  ...
                  <View style={FormStyle.terms}>
                    ...
                    >
                      <Text style={FormStyle.termsText2}>
                        Terms and Conditions
                      </Text>
                    </TouchableOpacity>
                  </View>
                  ...
                  <View style={FormStyle.bottom}>
                    ...
                    >
                      <Text style={FormStyle.gotoSign}>Signup</Text>
                    </TouchableOpacity>
                  </View>
                </>
              );
