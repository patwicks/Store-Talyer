        ...
        <View style={styles.form}>
          ...
          <Formik
            initialValues={{
              ...
              coverPhotoURL:
                "https://res.cloudinary.com/dxcbmlxoe/image/upload/v1630306438/store_cover_photo/default-cover-photo_zb6vzv.jpg",
              latitude: "",
              longitude: "",
              rating: 0,
              fullyVerified: false,
            ...
            onSubmit={(values, actions) => {
              navigation.navigate("Services", { storeData: values });
            }}
          >
            {(props) => {
              return (
