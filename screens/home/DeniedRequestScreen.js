...
export default function DeniedRequestScreen() {
    ...
    >
      ...
      >
        {reqData?.length > 0 ? (
          <>
            {reqData
              ?.filter((m) => m.transactionStatus === "denied")
              .map((data, index) => {
                return (
                  <TouchableOpacity
                    key={index}
      ...
      <Modal animationType="slide" transparent={true} visible={openModal}>
        <View style={styles.modalMainContainer}>
          ...
          <View style={styles.statusContainer}>
            <AntDesign name="exclamationcircle" size={24} color="#e62e00" />
            <Text style={{ marginLeft: 5 }}>Denied</Text>
          </View>
        </View>
      </Modal>
    </View>
