...
export default function StoreProfileScreen({ navigation }) {
  ...
  const uploadImageProfile = () => {
    ...
    API.post("/api/store/upload", formData, {
      headers: {
  ...
  const uploadCoverPhoto = () => {
    ...
    API.post("/api/store/upload/cover", formData, {
      headers: {
        Accept: "application/json",
        "Content-Type": "multipart/form-data",
        authtoken: token,
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={Styles.infoContainer}>
          ...
          <View style={Styles.btnContainerTop}>
            ...
            >
              <Text style={Styles.btnTextTop}>Gallery</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={Styles.btnTop}
              onPress={() => {
            ...
            >
              <Text style={Styles.btnTextTop}>Permit</Text>
            </TouchableOpacity>
          </View>
          <View style={Styles.detailsContainer}>
            <View style={Styles.mapContainer}>
              {isLoading ? (
                <ActivityIndicator color="#0073e6" size="large" />
              ) : (
                <MapView
            ...
            <View style={Styles.infContainer}>
              ...
              <Text style={Styles.info}>
                <Text>Store name: </Text> {storeName}
              </Text>
            </View>
            <View style={Styles.infContainer}>
              <MaterialIcons
              ...
              />
              <Text style={Styles.info}>
                <Text>Store Address: </Text> {storeAddress}
              </Text>
            </View>
            <View style={Styles.nameContainer}>
              ...
              <View>
                <Text style={Styles.info}>
                  <Text>Owner: </Text> {firstname} {middlename} {lastname}
                </Text>
                <Text style={Styles.info}>
