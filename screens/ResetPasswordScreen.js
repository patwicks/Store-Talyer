...
export default function ResetPasswordScreen({navigation, route}) {
    ...
    const handleResetPassword = (data) => {
        const url = `https://api-find-talyer.herokuapp.com/api/store/reset/${user_id}`;
        axios
            .put(url, data)
            .then(response => {
    ...
    return (
        ...
        <View style={styles.mainContainer}>
            <View style={styles.resetFormContainer}>
                <Image source={require('../assets/images/reset-password.png')} style={{alignSelf: 'center'}}/>
                ...
                {(props) => {
                    return(
                        ...
                        <Text style = {styles.inputError}>
                            {props.touched.otpUsed ? (<Text  style = {styles.inputError}>{props.errors.otpUsed}</Text>) : null}
                        </Text>
                        {/* Password */}
                        <Text>Password</Text>
                        <View style={styles.passContainer}>
                        ...
                        <Text style = {styles.inputError}>
                            {props.touched.confirmPassword ? (<Text  style = {styles.inputError}>{props.errors.confirmPassword}</Text>) : null}
                        </Text>
                        <TouchableOpacity style={styles.btnReset} onPress={props.handleSubmit}>
                            {props.isSubmitting ? <ActivityIndicator size='large' color='#ffffff' /> :  <Text style={styles.resetText}>Reset</Text>}
                        </TouchableOpacity>
                       </>
                    )
                }}
